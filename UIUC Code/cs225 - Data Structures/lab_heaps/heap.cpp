...
size_t heap<T, Compare>::maxPriorityChild(size_t currentIdx) const
{
    ...
    if(_elems.size() <= rightChild(currentIdx) || higherPriority(_elems[leftChild(currentIdx)],_elems[rightChild(currentIdx)])){
