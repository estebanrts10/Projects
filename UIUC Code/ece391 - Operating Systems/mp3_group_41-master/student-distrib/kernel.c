...
#include "debug.h"
#include "tests.h"
#include "idt_init.h"   // Added for IDT initialization
#include "RTC.h"        // Added for RTC initialization
#include "paging.h"
#include "terminal.h"
...
void entry(unsigned long magic, unsigned long addr) {
    ...
    if (CHECK_FLAG(mbi->flags, 3)) {
        ...
        // init global vars for file system
        filesystem_address = mod->mod_start;
